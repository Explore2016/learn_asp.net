...
namespace WebApplication1
{
    ...
    public class up_file_load : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            use_change.Executechange("insert into F_address(Address,file_name) values(@Address,@file_name)", new SqlParameter("@Address", filepath), new SqlParameter("@file_name",file_name));
